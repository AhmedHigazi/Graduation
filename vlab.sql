...
CREATE TABLE `assistantfactor` (
  ...
  `AssistantFactor` varchar(25) NOT NULL
...
INSERT INTO `assistantfactor` (`assFa_id`, `name`, `AssistantFactor`) VALUES
(7, 'aaa', ''),
(8, 'ahmed', 'wnhijqw'),
(9, 'sagxhys', 'vZH');
...
INSERT INTO `equation` (`equation_id`, `name`, `input`, `result`, `Reverse_Equation`) VALUES
(1, 'vhgvh', 'vjvjg', 'vvg', 1),
(2, 'jhj', 'bUJK', 'nkh', 0);
...
--
ALTER TABLE `assistantfactor`
  MODIFY `assFa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `matrale`
  MODIFY `matrale_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
